...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		...
		...
		<label for="job_level">เลเวล Job:</label>
	...
	<p>	
		<label for="online">ออนไลน์ :</label>
...
<table class="vertical-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('ch.char_id', 'รหัสตัวละคร') ?></th>
		<th><?php echo $paginator->sortableColumn('userid', 'ไอดี') ?></th>
		<th><?php echo $paginator->sortableColumn('char_name', 'ชื่อตัวละคร') ?></th>
		<th>คราส</th>
		<th><?php echo $paginator->sortableColumn('ch.base_level', 'เลเวล Base') ?></th>
		<th><?php echo $paginator->sortableColumn('ch.job_level', 'เลเวล Job') ?></th>
		<th><?php echo $paginator->sortableColumn('ch.zeny', 'เงิน') ?></th>
		<th colspan="2"><?php echo $paginator->sortableColumn('guild_name', 'กิลด์') ?></th>
		...
		<th><?php echo $paginator->sortableColumn('ch.online', 'ออนไลน์') ?></th>

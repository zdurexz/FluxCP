...
<h2>อันดับเงิน</h2>
<h3>
	<?php echo number_format($limit=(int)Flux::config('ZenyRankingLimit')) ?> อันดับเงิน
...
<table class="horizontal-table table table-striped ">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked info" title="<strong>'.htmlspecialchars($chars[$i]->char_name).'</strong> is the richest '.$topRankType.'!"' ?>>
